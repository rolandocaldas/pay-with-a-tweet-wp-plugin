...
<div class="wrap">
    ...
    <h2><?php print __("Manage your buttons", PWT_PLUGIN); ?> 
        <a href="<?php print admin_url('admin.php?page=pay-with-tweet/admin/pwt-create-button.php'); ?>" class="add-new-h2"><?php print __('New payment button', PWT_PLUGIN); ?></a></h2>
    <?php if ($message) : ?>
                            ...
                            <div class="row-actions">
                                <span class="delete">
                                    <a class="submitdelete" onclick="return showNotice.warn();"
                                       href="<?php print admin_url('admin.php?page=pay-with-tweet/admin/pwt-buttons.php&amp;action=delete&amp;button=' . $button->id . '&amp;_wpnonce=' . wp_create_nonce('delete-button_' . $button->id)); ?>"><?php print __('Delete'); ?></a>                                    
                                </span>
                                 | 
                                <span class="delete">
                                    <a class="submitdelete" onclick="return showNotice.warn();"
                                       href="<?php print admin_url('admin.php?page=pay-with-tweet/admin/pwt-buttons.php&amp;action=delete_all&amp;button=' . $button->id . '&amp;_wpnonce=' . wp_create_nonce('delete-button_' . $button->id)); ?>"><?php print __( 'Delete Permanently' ); ?></a>
                                </span>
                            </div>		
                        </td>
